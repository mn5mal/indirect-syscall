...
```dumpbin /imports nameOfTheProgram.exe```<br />
    ...
    Standard method using **kernel32.dll**:<img width="922" height="853" alt="normal" src="https://github.com/user-attachments/assets/6b16f73d-59fc-4b8f-b478-97b26bc49b13" />
